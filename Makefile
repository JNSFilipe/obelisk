...
help: ## Show this help
	...
	@printf "  \033[33mUpdate everything and activate\033[0m\n"
	@printf "    make switch  (= flake update + brew update/upgrade + activate + gc)\n\n"
	@printf "  \033[33mActivate without updating\033[0m\n"
	@printf "    make switch-locked\n\n"

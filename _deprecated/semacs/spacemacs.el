...
(defun obelisk/evil-shift-right ()
  (interactive)
  (evil-shift-right evil-visual-beginning evil-visual-end)
  (evil-normal-state)
  (evil-visual-restore))

(defun obelisk/evil-shift-left ()
  (interactive)
  (evil-shift-left evil-visual-beginning evil-visual-end)
  (evil-normal-state)
  (evil-visual-restore))

(defun obelisk/dired-open ()
...
(defun obelisk/dired-open-split ()
...
(defun obelisk/dired-create-path (name)
...
(defun obelisk/dired-toggle-mark ()
...
(defun obelisk/dired-toggle-hidden-files ()
  "Toggle visibility of hidden files in Dired."
  (interactive)
  (setq switches dired-actual-switches)
  (if (string-match "-al" switches)
      (setq dired-actual-switches (concat "-l " (replace-regexp-in-string "-al" "" switches)))
    (setq dired-actual-switches (concat "-al " switches)))
  (revert-buffer))

(defun obelisk/xy-window-pixel-ratio ()
...
(defun obelisk/auto-split-window ()
  "Determine split direction based on window dimensions"
  (interactive)
  (if (> (obelisk/xy-window-pixel-ratio) 1.0)
...
(defun obelisk/toggle-maximize-layout ()
...
before packages are loaded."
  ...
  (with-eval-after-load 'dired
    (evil-define-key 'normal dired-mode-map
      ...
      (kbd "H") 'obelisk/close-dired
      (kbd "l") 'obelisk/dired-open
      (kbd "L") 'obelisk/dired-open-split
      (kbd "m") 'obelisk/dired-toggle-mark
      (kbd "t") 'dired-toggle-marks
      (kbd "f") 'dired-do-search           ;; Search marked files
      (kbd "a") 'obelisk/dired-create-path
      (kbd "y") 'obelisk/dired-do-yank
      (kbd "p") 'obelisk/dired-do-paste
      (kbd "c") 'diredp-do-command-in-marked
      (kbd ".") 'dired-mark-files-regexp
      (kbd "s") 'dired-mark-extension
      (kbd "G") 'diredp-do-grep-recursive
      (kbd "Y") 'dired-do-copy
      ...
      (kbd "C") 'dired-copy-filename-as-kill ;; Copies filename to kill ring
      (kbd "Z") 'dired-do-compress
      (kbd ".") 'obelisk/dired-toggle-hidden-files
